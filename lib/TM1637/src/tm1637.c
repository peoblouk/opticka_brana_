...
//! Function to start wire transaction
...
//! Function to stop wire transaction
...
//! Function to write a unsigned char to the controller
...
//! Function to write a sequence of unsigned chars to the controller
...
//! Function to set brightness (0-8)
...
//! Function for passing a string such as "12:34" or "45 67" or "-- --"
